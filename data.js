...
export const skillData = [
  ...
  },
  {
    ...
    skillDescription:
      "Developing server-side logic, databases, and APIs to support web applications.",
    icon: FaServer,
  },
  {
    skillName: "Git and GitHub",
    skillDescription:
      "Version control and collaboration using Git for tracking changes in source code and GitHub for hosting repositories.",
    icon: FaGithub,
  },
  {
